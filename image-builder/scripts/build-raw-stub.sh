...
OUT="$ROOT_DIR/image-builder/output/${DISTRO_NAME}-${DISTRO_VERSION}-${TARGET_ARCH}.raw.stub"
cat > "$OUT" <<EOF
RAW STUB
--------
This is a placeholder artifact descriptor.
No authoritative OpenClaw raw-image tooling was defined in the extracted docs.
...
Next step:
- Choose and wire a real raw-disk image toolchain.
EOF
